 ...
 * </p>
 */
public class CustomeReport implements IReporter {

	private static final Logger LOG = Logger.getLogger(CustomeReport.class);
	...
	private static String outFilename = "SmartOnboarding-report.html";
	...
	public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
		...
		Comparator<ISuite> suiteComparator = new comparatorListener(xmlSuites);
        suites.sort(suiteComparator);

       // System.out.println(Arrays.toString(suites.toArray()));
		for (ISuite suite : suites) {
			suiteResults.add(new SuiteResult(suite));
		}
		//System.out.println(Arrays.toString(suiteResults.toArray()));
		writeDocumentStart();
		writeHead();
		writeBody();
		writeDocumentEnd();
	...
	protected void writeHead() {
		writer.print("<head>");
		writer.print("<title>SmartERP Report</title>");
		writeStylesheet();
		writer.print("</head>");
	}
	...
	protected void writeBody() {
		writer.print("<body>");
		writeReportTitle("SmartERP Report");
		writeSuiteSummary();
			...
			for (ClassResult classResult : classResults) {
				...
				for (MethodResult methodResult : classResult.getMethodResults()) {
					...
					buffer.append("<td><a href=\"#m").append(scenarioIndex).append("\">")
							.append(methodName + "</a></td>")// .append("<td rowspan=\"1\">" + aResult.getName() +
																// "</td>")
	...
	protected void writeReporterMessages(List<String> reporterMessages) {
		...
		/*
		 * writer.print("<div class=\"messages\">"); Iterator<String> iterator =
		 * reporterMessages.iterator(); assert iterator.hasNext();
		 * writer.print(Utils.escapeHtml(iterator.next())); while (iterator.hasNext()) {
		 * writer.print("<br/>"); writer.print(Utils.escapeHtml(iterator.next())); }
		 * writer.print("</div>");
		 */}
