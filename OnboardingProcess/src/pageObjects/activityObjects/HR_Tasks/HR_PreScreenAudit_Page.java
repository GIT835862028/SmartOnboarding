...
public class HR_PreScreenAudit_Page extends BaseClass {
	private static WebElement element;
	public static boolean GetStartedLnkExts;

	public HR_PreScreenAudit_Page(WebDriver driver) {
		super(driver);
	}
	...
	public static WebElement chkbox_agree() throws Exception {
		...
		try {
			...
			Log.info("chkbox_agree found in the HR_PreScreenAudit_Page");
		} catch (Exception e) {
			Log.info("chkbox_agree not found in the HR_PreScreenAudit_Page");
			throw (e);
		}
		return element;
	}
	...
	public static WebElement btn_acknowledg() throws Exception {
		...
		try {
			...
			Log.info("btn_acknowledg found in the HR_PreScreenAudit_Page");
		} catch (Exception e) {
			Log.info("btn_acknowledg not found in the HR_PreScreenAudit_Page");
			throw (e);
		}
		return element;
	}
