...
public class SetupOrgContatcts_DefaultTheme_Logo extends psUtility {
	...
	public static void Execute() throws Exception {
		...
		//Already change the value in OrginizationThemechange Script
		...
		Reporter.log("Setup Organization Contacts,Default Theme And Logo Performed Successfully");
